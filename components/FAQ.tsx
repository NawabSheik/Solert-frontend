...
const FAQSection = () => {
  return (
    ...
    <section className="faq flex justify-between items-center bg-black ">
      <div className="container mx-auto">
        <h2 className="text-4xl font-bold text-center mb-12 text-slate-50">Frequently Asked Questions</h2>
